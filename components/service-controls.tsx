...
export function ServiceControls() {
  const { serviceStatus, startService, stopService, installService, restartService } = useFolderStore()
    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>Gérer le service de traitement de fichiers</CardDescription>
          </div>
          {getStatusBadge()}
        </div>
      </CardHeader>
      <CardContent>
        <div className="flex flex-wrap gap-2">
          <Button onClick={handleStart} disabled={serviceStatus === "running" || serviceStatus === "installing"}>
          ...
          <Button
            onClick={handleStop}
            variant="destructive"
            disabled={serviceStatus === "stopped" || serviceStatus === "installing"}
          >
            <Square className="mr-2 h-4 w-4" />
            Arrêter
          </Button>
          <Button onClick={handleInstall} variant="secondary" disabled={serviceStatus === "installing"}>
